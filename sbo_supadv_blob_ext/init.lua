...
sbz_api.register_machine("sbo_supadv_blob_ext:extractor", {
    description =
...
minetest.register_craft({
    output = "sbo_supadv_blob_ext:extractor",
    recipe = {
        { "sbz_resources:matter_blob", "sbz_resources:matter_blob",         "sbz_resources:matter_blob" },
        { "sbz_resources:matter_blob", "sbo_adv_peb_ext:advanced_peb_extractor", "sbz_resources:matter_blob" },
