...
minetest.register_node('sbo_adv_injector:injector', {
    description = 'Advanced Automatic Filter-Injector',
    info_extra = 'Pushes items out of blocks... and into tubes or other blocks, has a one block gap between block pulling from.',
    tiles = {
        { name = 'afilter_side.png^[transformFX', animation = animation_def },
        { name = 'afilter_side.png^[transformFX', animation = animation_def },
        'afilter_output.png',
        'afilter_input.png',
        { name = 'afilter_side.png', animation = animation_def },
        { name = 'afilter_side.png^[transformFX', animation = animation_def },
    },
    paramtype2 = 'facedir',
    ...
    action = function(pos, node, meta, supply, demand)
        ...
        frompos = vector.subtract(frompos, dir)
