...
sbo_api.quests.on_craft["sbo_rein_cable:power_pipe"] = "Reinforced Power Cables"
...
unified_inventory.add_category_item('machines', "sbo_rein_cable:power_pipe")
unified_inventory.add_category_item('machines', "sbo_rein_cable:airtight_power_cable")
