...
core.register_craft {
    ...
    recipe = {
        ...
        { "sbz_resources:strange_dust", "sbz_planets:dwarf_orb", "sbz_resources:strange_dust", },
        { "sbz_resources:strange_dust", "sbz_resources:strange_dust", "sbz_resources:strange_dust", },
    }
}
----------------------------------------------------------------------------------------------------------
...
local actions = function(pos, _, puncher)
    ...
    for _ = 1, minetest.get_item_group(tool_name, "core_drop_multi") do
        if math.random(1, 10) == 1 then
            puncher:get_inventory():add_item("main", "sbz_resources:phlogiston")
            minetest.sound_play("punch_core", {
                gain = 1.0,
                max_hear_distance = 32,
                pos = pos
...
minetest.register_node("sbo_emmiters:phlogiston", {
    description = "Movable Phlogiston Emitter",
    tiles = { "oranger_movable_emitter.png" },
    groups = { transparent = 1, matter = 1, level = 2 },
    sunlight_propagates = true,
    paramtype = "light",
    light_source = 14,
...
core.register_craft {
    output = "sbo_emmiters:phlogiston",
    recipe = {
        { "sbz_resources:phlogiston", "sbz_resources:phlogiston", "sbz_resources:phlogiston", },
        { "sbz_resources:phlogiston", "sbz_planets:dwarf_orb",    "sbz_resources:phlogiston", },
        { "sbz_resources:phlogiston", "sbz_resources:phlogiston", "sbz_resources:phlogiston", },
    }
}
...
core.register_craft {
    ...
    recipe = {
        ...
        { "sbz_resources:raw_emittrium", "sbz_planets:dwarf_orb",       "sbz_resources:raw_emittrium", },
        { "sbz_resources:raw_emittrium", "sbz_resources:raw_emittrium", "sbz_resources:raw_emittrium", },
    }
}
