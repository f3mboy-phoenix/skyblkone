...
nuke.spawn_tnt = function(pos, entname)
	...
	minetest.sound_play("tnt_ignite", {pos = pos, gain = 1.0, max_hear_distance = 16})
...
nuke.register_tnt = function(nodename, def)
	...
	function entity:on_step(dtime)
		...
		if self.timer > def.explodetime then -- boom!
			minetest.sound_play("tnt_explode", {pos = pos, gain = 0.8, max_hear_distance = 32})
...
minetest.register_craft({
	output = "sbo_explosives:extrosim_tnt 4",
	recipe = {
		{"sbo_explosives:thermite_stick", "sbo_extrosim:raw_extrosim", "sbo_explosives:thermite_stick"},
		{"sbo_extrosim:raw_extrosim", "sbo_explosives:thermite_stick", "sbo_extrosim:raw_extrosim"},
		{"sbo_explosives:thermite_stick", "sbo_extrosim:raw_extrosim", "sbo_explosives:thermite_stick"},
	}
})
...
minetest.register_craft({
	output = "sbo_explosives:extrosim_tntx 1",
	recipe = {
		{"sbo_explosives:extrosim_tnt", "sbo_extrex:extrex_ingot", "sbo_explosives:extrosim_tnt"},
		{"sbo_extrex:extrex_ingot", "sbo_explosives:extrosim_tnt", "sbo_extrex:extrex_ingot"},
		{"sbo_explosives:extrosim_tnt", "sbo_extrex:extrex_ingot", "sbo_explosives:extrosim_tnt"},
	}
})
...
minetest.register_craft({
	output = "sbo_explosives:uranium_tnt 4",
	recipe = {
		{"sbo_explosives:nuclear_stick", "sbz_chem:uranium_crystal", "sbo_explosives:nuclear_stick"},
		{"sbz_chem:uranium_crystal", "sbo_explosives:nuclear_stick", "sbz_chem:uranium_crystal"},
		{"sbo_explosives:nuclear_stick", "sbz_chem:uranium_crystal", "sbo_explosives:nuclear_stick"},
	}
})


nuke.register_tnt("sbo_explosives:uranium_tntx", {
	description = "Extreme Uranium TNT",
	tiles = {"uranium_tnt_top.png", "uranium_tnt_bottom.png", "uranium_tnt_side_x.png"},
	on_explode = function(pos)
		on_explode_split(pos, 3, "sbo_explosives:uranium_tnt")
	end,
})

minetest.register_craft({
	output = "sbo_explosives:uranium_tntx 1",
	recipe = {
		{"sbo_explosives:uranium_tnt", "sbo_resium:crystal", "sbo_explosives:uranium_tnt"},
		{"sbo_resium:crystal", "sbo_explosives:uranium_tnt", "sbo_resium:crystal"},
		{"sbo_explosives:uranium_tnt", "sbo_resium:crystal", "sbo_explosives:uranium_tnt"},
	}
})
...
minetest.register_craft({
	output = "sbo_explosives:instantinium_tnt 4",
	recipe = {
		{"sbo_explosives:uranium_tnt", "sbz_instatube:instantinium", "sbo_explosives:uranium_tnt"},
		{"sbz_instatube:instantinium", "sbo_explosives:uranium_tnt", "sbz_instatube:instantinium"},
		{"sbo_explosives:uranium_tnt", "sbz_instatube:instantinium", "sbo_explosives:uranium_tnt"},
	}
})
...
minetest.register_craft({
	output = "sbo_explosives:instantinium_tntx 1",
	recipe = {
		{"sbo_explosives:uranium_tntx", "sbz_instatube:instantinium", "sbo_explosives:uranium_tntx"},
		{"sbz_instatube:instantinium", "sbo_explosives:uranium_tntx", "sbz_instatube:instantinium"},
		{"sbo_explosives:uranium_tntx", "sbz_instatube:instantinium", "sbo_explosives:uranium_tntx"},
	}
})
