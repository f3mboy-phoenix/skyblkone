...
mobs:register_mob("sbo_animals:bee", {
	type = "animal",
	passive = true,
	hp_min = 1,
	hp_max = 2,
	...
	jump = true,
	drops = {
		{name = "sbo_animals:honey", chance = 2, min = 1, max = 2}
	},
	water_damage = 1,
	lava_damage = 2,
	light_damage = 0,
	...
	on_rightclick = function(self, clicker)
		mobs:capture_mob(self, clicker, 50, 90, 0, true, "sbo_animals:bee")
	end,
...
mobs:alias_mob("sbo_mobs:bee", "sbo_animals:bee")
...
mobs.add_eatable("sbo_animals:honey", 4)
hbhunger.register_food("sbo_animals:honey", 4)
unified_inventory.add_category_item('food', "sbo_animals:honey")
...
core.register_node("sbo_animals:beehive", {
	...
	walkable = true,
	groups = {matter = 3, flammable = 1, disable_suffocation = 1},
	...
	after_place_node = function(pos, placer, itemstack)
		...
		if placer and placer:is_player() then
			...
			core.set_node(pos, {name = "sbo_animals:beehive", param2 = 1})

			if math.random(4) == 1 then
				core.add_entity(pos, "sbo_animals:bee")
			end
		end
	end,
...
core.register_craft({
	output = "sbo_animals:beehive",
	recipe = {{"sbo_animals:bee","sbo_animals:bee","sbo_animals:bee"}}
})

-- honey block and craft recipes

core.register_node("sbo_animals:honey_block", {
...
core.register_craft({
	output = "sbo_animals:honey_block",
	recipe = {
		{"sbo_animals:honey", "sbo_animals:honey", "sbo_animals:honey"},
		{"sbo_animals:honey", "sbo_animals:honey", "sbo_animals:honey"},
		{"sbo_animals:honey", "sbo_animals:honey", "sbo_animals:honey"}
	}
})
...
core.register_craft({
	output = "sbo_animals:honey 9",
	recipe = {
		{"sbo_animals:honey_block"}
	}
})
...
core.register_abm({
	...
	action = function(pos, node)
		...
		if #core.find_nodes_in_area_under_air(
				...
				{x = pos.x + 4, y = pos.y + 3, z = pos.z + 4}, "sbz_bio:stemfruit") > 3 then

			inv:add_item("beehive", "sbo_animals:honey")
		end
	end
})
