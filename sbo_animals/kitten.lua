...
mobs:register_mob("sbo_animals:kitten", {
	stepheight = 0.6,
	type = "animal",
	specific_attack = {"sbo_animals:rat"},
	damage = 1,
	...
	jump = false,
	drops = {
		{name = "sbz_bio:rope", chance = 1, min = 0, max = 1}
	},
	water_damage = 0.01,
	lava_damage = 5,
	fear_height = 3,
	...
	follow = {
		"sbo_animals:rat", "group:food_fish_raw", "sbo_animals:bucket_milk", "sbo_fish:fish"
	},
	view_range = 8,
	...
	on_rightclick = function(self, clicker)
		...
		if mobs:feed_tame(self, clicker, 4, true, true) then
			...
			if item == "sbo_animals:bucket_milk" and core.get_modpath("sbz_chem") and not mobs.is_creative(clicker:get_player_name()) then
	...
	do_custom = function(self, dtime)
		...
		core.add_item(pos, "sbo_animals:hairball")
...
mobs:alias_mob("sbo_mobs:kitten", "sbo_animals:kitten")

-- hairball and items

local hairball_items = {
	"sbo_wood:stick", "sbz_bio:colorium_sapling", "sbz_resources:antimatter_dust", "sbz_resources:charged_particle",
	"sbo_animals:rat", "sbz_resources:matter_dust", "sbz_resources:pebble", "sbz_resources:strange_dust", "",
	"",
	"sbz_bio:paper", "",
	"sbo_animals:chicken_feather","",
	"",
}

core.register_craftitem("sbo_animals:hairball", {
