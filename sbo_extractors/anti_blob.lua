...
sbo_api.quests.on_craft["sbo_extractors:adv_antiblob_ext"] = "Advanced AntiBlob Extractor"
...
core.register_alias("sbo_adv_antiblob_ext:extractor", "sbo_extractors:adv_antiblob_ext")
