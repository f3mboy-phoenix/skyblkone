...
sbz_api.register_machine("sbo_extractors:simp_core_ext", {
    description =
...
minetest.register_craft({
    output = "sbo_extractors:simp_core_ext",
    recipe = {
        ...
        { "sbz_resources:compressed_core_dust", "sbo_extrosim:circuit", "sbz_resources:compressed_core_dust" }
    }
})
...
core.register_alias("sbo_simp_core_ext:simple_core_extractor", "sbo_extractors:simp_core_ext")
