sbz_api.register_machine("sbo_extractors:sup_ext", {
...
sbo_api.quests.on_craft["sbo_extractors:sup_ext"] = "Super Matter Extractor"
...
core.register_alias("sbo_sup_ext:extractor", "sbo_extractors:sup_ext")
