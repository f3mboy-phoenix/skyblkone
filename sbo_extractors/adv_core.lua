...
sbz_api.register_machine("sbo_extractors:adv_core_ext", {
    description =
...
minetest.register_craft({
    output = "sbo_extractors:adv_core_ext",
    recipe = {
        { "sbz_resources:compressed_core_dust", "sbz_resources:compressed_core_dust",      "sbz_resources:compressed_core_dust" },
        { "sbz_resources:compressed_core_dust", "sbo_extractors:simp_core_ext",            "sbz_resources:compressed_core_dust" },
        { "sbz_resources:compressed_core_dust", "sbo_resium:circuit",                      "sbz_resources:compressed_core_dust" }
    }
})

sbo_api.quests.on_craft["sbo_extractors:adv_core_ext"] = "Advanced Compressing Core Extractor"
...
core.register_alias("sbo_adv_core_ext:extractor", "sbo_extractors:adv_core_ext")
