...
sbz_api.register_machine("sbo_extractors:adv_peb_ext", {
    description =
...
minetest.register_craft({
    output = "sbo_extractors:adv_peb_ext",
    recipe = {
        ...
        { "sbz_resources:stone", "sbo_extrosim:circuit", "sbz_resources:stone" }
    }
})

sbo_api.quests.on_craft["sbo_extractors:adv_peb_ext"] = "Cement Mixer"
...
core.register_alias("sbo_adv_peb_ext:advanced_peb_extractor", "sbo_extractors:adv_peb_ext")
