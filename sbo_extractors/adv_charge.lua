...
sbz_api.register_machine("sbo_extractors:adv_field_ext", {
    description =
    ...
    on_rightclick = function(pos, node, player, pointed_thing)
        ...
        minetest.show_formspec(player_name, "sbz_power:sbo_adv_field_ext",
            "formspec_version[7]" ..
            "size[8.2,9]" ..
    ...
    action = function(pos, node, meta)
        local inv = meta:get_inventory()
        local itemstack = ItemStack("sbz_power:simple_charged_field")
        ...
        if inv:room_for_item("main", itemstack) then
            ...
            minetest.add_particlespawner({
                ...
                vertical = false,
                texture = "simple_charged_field.png",
                glow = 10
            })
        end
    end,
...
minetest.register_craft({
    output = "sbo_extractors:adv_field_ext",
    recipe = {
        { "sbz_power:simple_charged_field", "sbz_power:simple_charged_field",    "sbz_power:simple_charged_field" },
        { "sbz_power:simple_charged_field", "sbo_extractors:simp_charge_ext", "sbz_power:simple_charged_field" },
        { "sbz_power:simple_charged_field", "sbo_resium:circuit",                "sbz_power:simple_charged_field" }
    }
})

sbo_api.quests.on_craft["sbo_extractors:adv_field_ext"] = "Advanced Field Extractor"
...
core.register_alias("sbo_adv_field_ext:extractor", "sbo_extractors:adv_field_ext")
