sbz_api.register_machine("sbo_extractors:adv_anti_ext", {
...
minetest.register_craft({
    output = "sbo_extractors:adv_anti_ext",
    recipe = {
        { "sbz_resources:core_dust",       "sbz_resources:antimatter_blob",        "sbz_resources:core_dust" },
        { "sbz_resources:antimatter_blob", "sbo_extractors:anti_ext", "sbz_resources:antimatter_blob" },
...
core.register_alias("sbo_adv_anti_ext:extractor", "sbo_extractors:adv_anti_ext")
