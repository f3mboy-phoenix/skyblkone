...
unified_inventory.register_category('extractors', {
	symbol = "sbo_extractors:adv_metal_ext_aluminum",
	label = "Metal Extractors"
})
core.register_craftitem("sbo_extractors:n64_processor", {
...
sbo_api.quests.on_craft["sbo_extractors:adv_metal_ext_"..element] = "Advanced Metal Extractor"
sbz_api.register_machine("sbo_extractors:adv_metal_ext_"..element, {
    description =
...
minetest.register_craft({
    output = "sbo_extractors:adv_metal_ext_"..element,
    recipe = {
        { block, block,         block },
...
unified_inventory.add_category_item('extractors', "sbo_extractors:adv_metal_ext_"..element)
core.register_alias("sbo_adv_metal_ext:".. element .."_extractor", "sbo_extractors:adv_metal_ext_"..element)
