sbz_api.register_machine("sbo_extractors:anti_ext", {
    description = "Simple Antimatter Extractor",
    tiles = { "anti_extractor.png" },
...
minetest.register_craft({
    output = "sbo_extractors:anti_ext",
    recipe = {
...
core.register_alias("sbo_anti_ext:simple_antimatter_extractor", "sbo_extractors:anti_ext")
