...
local function try_linking(pos, meta)
    local nodes = minetest.find_nodes_in_area(vector.subtract(pos, offset), vector.add(pos, offset),
        { "sbo_reactors:amethyst_reactor_core_off", "sbo_reactors:amethyst_reactor_core_on" }, true)
    local firstpos
    if nodes["sbo_reactors:amethyst_reactor_core_off"] ~= nil then
        firstpos = nodes["sbo_reactors:amethyst_reactor_core_off"][1]
    elseif nodes["sbo_reactors:amethyst_reactor_core_on"] ~= nil then
        firstpos = nodes["sbo_reactors:amethyst_reactor_core_on"][1]
    else
...
minetest.register_node("sbo_reactors:amethyst_reactor_shell", {
    description = "Amethyst Reactor Shell",
    info_extra = "Used for the amethyst reactor",
    tiles = {
        "amethyst_reactor_shell.png", "blank.png^[invert:rgba^[multiply:#A163FF"
    },
...
minetest.register_craft {
    output = "sbo_reactors:amethyst_reactor_shell",
    recipe = {
        { "sbz_resources:compressed_core_dust", "sbo_crystals:amethyst_shard",                 "sbz_resources:compressed_core_dust" },
        { "sbo_crystals:amethyst_shard",                 "sbz_resources:compressed_core_dust", "sbo_crystals:amethyst_shard" },
        { "sbz_resources:compressed_core_dust", "sbo_crystals:amethyst_shard",                 "sbz_resources:compressed_core_dust" },
    }
}

minetest.register_node("sbo_reactors:amethyst_reactor_glass", {
    description = "Amethyst Reactor Glass",
    info_extra = "Decorational, acts like a shell",
    tiles = {
        "amethyst_reactor_shell.png", "blank.png"
    },
    drawtype = "glasslike_framed",
    paramtype = "light",
    groups = { matter = 1, reactor_shell = 1, charged = 1 },
...
minetest.register_craft {
    output = "sbo_reactors:amethyst_reactor_glass",
    recipe = {
        { "sbz_power:simple_charged_field", "sbo_crystals:tinted_glass",    "sbz_power:simple_charged_field" },
        { "sbo_crystals:tinted_glass",  "sbo_reactors:amethyst_reactor_shell", "sbo_crystals:tinted_glass" },
        { "sbz_power:simple_charged_field", "sbo_crystals:tinted_glass",    "sbz_power:simple_charged_field" }
    }
}

local reactor_shell = "blank.png^[invert:rgba^[multiply:#A163FF^amethyst_reactor_shell.png"

minetest.register_node("sbo_reactors:amethyst_reactor_item_input", {
    description = "Reactor Amethyst Input",
    info_extra = "ONLY ONE can be used in an amethyst reactor, supplies amethyst to the reactor core",
    ...
    tiles = {
        ...
        reactor_shell,
        "amethyst_reactor_item_input.png",
    },
    paramtype2 = "4dir",
    ...
    tube = {
        ...
        can_insert = function(pos, node, stack, direction, owner)
            if stack:get_name() ~= "sbo_crystals:amethyst_shard" then
                return false
            end
            local inv = minetest.get_meta(pos):get_inventory()
...
minetest.register_craft {
    output = "sbo_reactors:amethyst_reactor_item_input",
    recipe = {
        { "pipeworks:tube_1", "sbz_resources:retaining_circuit", "sbo_reactors:amethyst_reactor_shell" }
    }
}

sbz_api.register_stateful("sbo_reactors:amethyst_reactor_core", {
    description = "Amethyst Reactor Core",
    info_extra = "Don't let it explode!",
    tiles = {
        "amethyst_reactor_core.png"
    },
    groups = { matter = 1, reactor_shell = 1, charged = 1 },
...
minetest.register_craft {
    output = "sbo_reactors:amethyst_reactor_core",
    recipe = {
        { "sbo_reactors:amethyst_reactor_shell", "sbz_meteorites:neutronium",         "sbo_reactors:amethyst_reactor_shell", },
        { "sbz_meteorites:neutronium",        "sbo_reactors:resium_reactor_core", "sbz_meteorites:neutronium", },
        { "sbo_reactors:amethyst_reactor_shell", "sbz_meteorites:neutronium",         "sbo_reactors:amethyst_reactor_shell", }
    }
}
...
label[0.2,3.6;Amethyst]
box[2.2,3.2;9,1;grey]
box[2.2,3.2;%s,1;purple]
...
tooltip[relink;Use if 2 infoscreens are linked to the same reactor core]
        ...
        barchart_this_number(meta:get_int("amethyst_level"), 256))
end
...
minetest.register_node("sbo_reactors:amethyst_reactor_infoscreen", {
    description = "Amethyst Reactor Infoscreen",
    paramtype2 = "4dir",
    tiles = {
        reactor_shell,
        reactor_shell,
        ...
        reactor_shell,
        "amethyst_reactor_infoscreen.png",
    },
    groups = { matter = 1, reactor_shell = 1, charged = 1 },
    on_rightclick = function(pos)
        ...
        if linkedname ~= "sbo_reactors:amethyst_reactor_core_on" and linkedname ~= "sbo_reactors:amethyst_reactor_core_off" then
            if not try_linking(pos, meta) then
                meta:set_string("infotext", "No reactor nearby")
                meta:set_int("linked", 0)
                meta:set_string("formspec", "")
...
minetest.register_craft {
    output = "sbo_reactors:amethyst_reactor_infoscreen",
    recipe = {
        { "sbo_reactors:amethyst_reactor_glass", "sbo_reactors:amethyst_reactor_shell", "sbz_power:connector_off" }
    }
}

sbz_api.register_generator("sbo_reactors:amethyst_reactor_power_port", {
    description = "Amethyst Reactor Power Port",
    paramtype2 = "4dir",
    tiles = {
        reactor_shell,
        reactor_shell,
        ...
        reactor_shell,
        "amethyst_reactor_powerport.png",
    },
...
minetest.register_craft {
    output = "sbo_reactors:amethyst_reactor_power_port",
    recipe = {
        { "sbz_power:power_pipe", "sbo_reactors:amethyst_reactor_shell", "sbz_power:simple_charged_field" }
    }
}

minetest.register_node("sbo_reactors:amethyst_reactor_coolant_port", {
    description = "Amethyst Reactor Coolant Port",
    ...
    tiles = {
        ...
        reactor_shell,
        "amethyst_reactor_coolantport.png",
    },
...
minetest.register_craft {
    output = "sbo_reactors:amethyst_reactor_coolant_port",
    recipe = {
        { "sbz_power:fluid_pipe", "sbz_power:fluid_tank", "sbo_reactors:amethyst_reactor_shell" }
    }
}
...
local function core_tick(pos)
    ...
    for x = iter_start_pos.x, iter_start_pos.x + 6 do
        for y = iter_start_pos.y, iter_start_pos.y + 6 do
            for z = iter_start_pos.z, iter_start_pos.z + 6 do
                ...
                if node == "sbo_reactors:amethyst_reactor_power_port" then
                ...
                elseif node == "sbo_reactors:amethyst_reactor_infoscreen" then
                    if nodes.info == nil then
                        nodes.info = vec
                    else
                        err = "You can't have more than 1 infoscreen"
                    end
                elseif node == "sbo_reactors:amethyst_reactor_item_input" then
                    if nodes.amethyst == nil then
                        nodes.amethyst = vec
                    else
                        err = "You can't have more than 1 amethyst Input"
                    end
                elseif node == "sbo_reactors:amethyst_reactor_coolant_port" then
    ...
    local amethyst_stack, amethystmeta
    if nodes.amethyst then
        amethystmeta = minetest.get_meta(nodes.amethyst)
        amethyst_stack = amethystmeta:get_inventory():get_stack("main", 1)

        if tickcount == 0 then
            local newcount = amethyst_stack:get_count() - 16
            if newcount < 0 then
                err = "Not enough Amethyst"
                meta:set_int("tickcount", CONSUME_EMITTRIUM_EVERY_X_SEC) -- resets
            else
                amethyst_stack:set_count(amethyst_stack:get_count() - 16)
                amethystmeta:get_inventory():set_stack("main", 1, amethyst_stack)
            end
        end
    end
    ...
    if not err then
        ...
        infometa:set_int("amethyst_level", amethyst_stack:get_count())
        minetest.registered_nodes["sbo_reactors:amethyst_reactor_infoscreen"].on_reactor_update(nodes.info)
        --unlock_achievement(meta:get_string("owner"), "Building the amethyst reactor and turning it on")
    else
        sbz_api.turn_off(pos)
    end
end
...
minetest.register_abm({
    nodenames = { "sbo_reactors:amethyst_reactor_core_on" },
    action = core_tick,
    interval = 1,
    chance = 1,
})
...
mesecon.register_on_mvps_move(function(moved_nodes)
    for i = 1, #moved_nodes do
        ...
        if moved_node.node.name == "sbo_reactors:amethyst_reactor_power_port" then
        ...
        elseif moved_node.node.name == "sbo_reactors:amethyst_reactor_infoscreen" then
            local meta = minetest.get_meta(moved_node.pos)
...
unified_inventory.add_category_item('reactors', "sbo_reactors:amethyst_reactor_shell")
unified_inventory.add_category_item('reactors', "sbo_reactors:amethyst_reactor_glass")
unified_inventory.add_category_item('reactors', "sbo_reactors:amethyst_reactor_item_input")
unified_inventory.add_category_item('reactors', "sbo_reactors:amethyst_reactor_core_off")
unified_inventory.add_category_item('reactors', "sbo_reactors:amethyst_reactor_infoscreen")
unified_inventory.add_category_item('reactors', "sbo_reactors:amethyst_reactor_power_port")
unified_inventory.add_category_item('reactors', "sbo_reactors:amethyst_reactor_coolant_port")

sbo_api.quests.register_to("SBO: Other infos",{
    type = "text",
    info = true,
    title = "Amethyst Reactor",
    text =
        [[Amethyst Reactors produce 1GCj. Setup like Emittrium Reactors except 7x7x7]],
})
