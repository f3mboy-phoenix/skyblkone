...
sbz_api.register_machine("sbo_adv_blob_ext:advanced_blob_extractor", {
    description =
    "Advanced Blob Extractor",
    tiles = { "advanced_blob_extractor.png" },
    groups = { matter = 1, sbz_machine = 1, pipe_connects = 1 },
    sunlight_propagates = true,
    walkable = true,
    on_rightclick = function(pos, node, player, pointed_thing)
        local player_name = player:get_player_name()
        minetest.show_formspec(player_name, "sbz_power:advanced_blob_extractor_formspec",
            "formspec_version[7]" ..
            "size[8.2,9]" ..
...
sbo_api.quests.on_craft["sbo_adv_blob_ext:advanced_blob_extractor"] = "Advanced Blob Extractor"
sbo_api.quests.register_to("Questline: Resium",{
    type = "quest",
    title = "Advanced Blob Extractor",
    text =
        [[Useful for automation. Creates 1 matter blob per second.]],
    requires = { "Automation", }
})
