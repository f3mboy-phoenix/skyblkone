...
local function meteorite_explode(pos, type)
    ...
    local node_types = {
        compressed_core_dust = { "sbo_coric_meteorite:coric_matter", "sbz_meteorites:meteoric_metal" },
    }
    if not protected then
        for _ = 1, 16 do
...
minetest.register_entity("sbo_coric_meteorite:coric", {
    ...
    on_activate = function(self, staticdata, dtime)
        ...
        if staticdata and staticdata ~= "" then --not new, just unpack staticdata
            ...
            local types = { "compressed_core_dust" }
...
minetest.register_node("sbo_coric_meteorite:coric_matter", {
    ...
    tiles = { "compressed_core_dust.png^meteoric_overlay.png" },
    paramtype = "light",
    light_source = 10,
...
local function spawn_meteorite(pos)
    ...
    return minetest.add_entity(pos, "sbo_coric_meteorite:coric")
end
